...
export default class MainMenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Tu dong phat nhac menu sau user gesture (AudioContext policy mobile)
...
this.input.once("pointerdown", startMusic);
        // Thu phat ngay (desktop)
        try { startMusic(); } catch(e) { /* se phat sau touch */ }
        // Fallback: user tap lan dau -> phat nhac
        this.input.once("pointerdown", playMenu);
